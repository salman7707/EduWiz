...
const SidebarProvider = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
    ...
    onOpenMobileChange?: (openMobile: boolean) => void;
  }
>(
  (
    {
    ...
    const [_openMobile, _setOpenMobile] = React.useState(defaultOpen);
...
>(
  (
    ...
    //         data-mobile="true"
    //         className="w-[--sidebar-width] z-0 mt-10 p-0 text-sidebar-foreground [&>button]:hidden"
    //         style={
    //           {
