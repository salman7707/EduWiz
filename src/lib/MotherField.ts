...
const Motherfields: fieldsData[] = [
    ...
    { id: 5, theme: "dark", name:"motherprofession", label: "Profession", placeholder: "Profession", type: "number", justifyend: false, select: false },
    { id: 6, theme: "dark", name:"motherincome", label: "Income", type: "text", placeholder: "Income", justifyend: true, select: false },
];
