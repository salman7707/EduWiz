...
const Fatherfields: fieldsData[] = [
    ...
    { id: 5, name: "profession", theme: "dark", label: "Profession", placeholder: "Profession", type: "text", justifyend: false, select: false },
    { id: 6, name: "income", theme: "dark", label: "Income", type: "number", placeholder: "Income", justifyend: true, select: false },
];
